...
ggRandomForests R package, and maintain the hazard SAS/C package, an open-source
implementation of multi-phase hazard analysis for time-to-event decomposition
originally developed at Cleveland Clinic. I additionally develop and maintain a
suite of R packages (hvtiPlotR, hvtiRtables, hvtiRutilities, hvtiRdatasets) that
standardize figures, tables, utilities, and analytic dataset construction across
