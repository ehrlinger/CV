...
%% nihbiosketch.cls hardcodes \setmainfont{Arial}. Override here so the file
%% compiles on systems without Arial (e.g. Linux CI). TeX Gyre Heros is an
%% Arial/Helvetica-compatible font included in TeX Live Full.
